# scripts/05_02_GET_applications_by_program_id.py
# ================================================================
# Obtener Todas las Postulaciones de un Programa con Respuestas Completas
# 
# DESCRIPCIÓN:
# Script optimizado para obtener todas las postulaciones de un programa específico,
# incluyendo todas las respuestas completas (form_answers y field_answers) y
# exportarlas a Excel con todas las columnas disponibles.
#
# CARACTERÍSTICAS:
...
#
# RENDIMIENTO:
# - Con 1343 aplicaciones: ~2 minutos (vs 20-40 minutos versión secuencial)
...
#
# Salida:
#   - Excel: downloads/applications_program_{program_id}_full.xlsx
#   - Progreso: downloads/progress_program_{program_id}.json
# ================================================================
...
PROGRESS_FILE_TEMPLATE = "downloads/progress_program_{program_id}.json"
...
print(f"[OK] Total postulaciones encontradas: {len(applications_index)}")
...
if not applications_to_process:
    ...
    print(f">> Procesando {len(applications_to_process)} aplicaciones pendientes...")
